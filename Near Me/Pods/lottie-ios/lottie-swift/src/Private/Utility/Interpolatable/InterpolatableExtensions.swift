...
extension CurveVertex: Interpolatable {
    func interpolateTo(_ to: CurveVertex, amount: CGFloat, spatialOutTangent _: CGPoint?, spatialInTangent _: CGPoint?) -> CurveVertex {
...
extension TextDocument: Interpolatable {
    func interpolateTo(_ to: TextDocument, amount: CGFloat, spatialOutTangent _: CGPoint?, spatialInTangent _: CGPoint?) -> TextDocument {
        if amount == 1 {
            return to
        }
        return self
