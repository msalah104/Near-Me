...
final class TextCompositionLayer: CompositionLayer {
    ...
    init(textLayer: TextLayerModel, textProvider: AnimationTextProvider) {
        ...
        interpolatableAnchorPoint = KeyframeInterpolator(keyframes: textLayer.transform.anchorPoint.keyframes)
        interpolatableScale = KeyframeInterpolator(keyframes: textLayer.transform.scale.keyframes)
    ...
    override init(layer: Any) {
        ...
        interpolatableAnchorPoint = nil
        interpolatableScale = nil
